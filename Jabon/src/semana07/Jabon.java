...
public class Jabon extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		if 		( marc=="Palmolive Tripack" ){ prec=5.2 ;}
		else if ( marc=="Nivea Tripack" ){ prec=8.2 ;}
		else if ( marc=="Rexona Tripack" ){ prec=6.5 ;}
		else 	{ prec=7.4 ;}
		impC = prec*cant;
		...
		if 		( cant<12 ){ lap=2 ;}
		else if ( cant>12 & cant<24 ){ lap=4 ;}
		else if ( cant>24 & cant<36 ){ lap=1*cant ;}
		else 	{ lap=2*cant ;}
		
		
		txtS.setText("**REPORTE DEL PROGRAMA JABON**\n\n");
		...
		txtS.append("Lapiceros de obsequio : " + lap + "\n");
	}
